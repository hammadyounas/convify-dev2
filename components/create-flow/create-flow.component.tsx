...
import Sidebar from "../user/screens/Side-bar.component"
import SidebarComponent from "../user/screens/Side-bar.component"
import Listscreen from "../user/screens/List-screen.component"
enum VIEWS {
  MOBILE = "mobile",
  DESKTOP = "desktop",
}
      ...
      >
        <div className="flex h-full min-h-screen flex-row justify-between gap-0">
          ...
          >
            ...
            <Listscreen setArr={setArr} arr={arr} />
          </ScrollArea>
